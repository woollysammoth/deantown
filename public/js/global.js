(function(){
    ...
    DeanTown.prototype.updateLogo = function(){
        ...
        window.DeanTown.logo.style.webkitTransform = "scale(" + window.DeanTown.freqArray[12] / 100 + ")";
        window.DeanTown.logo.style.mozTransform = "scale(" + window.DeanTown.freqArray[12] / 100 + ")";
        window.DeanTown.logo.style.transform = "scale(" + window.DeanTown.freqArray[12] / 100 + ")";
    };
